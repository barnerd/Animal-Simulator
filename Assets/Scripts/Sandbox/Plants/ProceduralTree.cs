...
namespace BarNerdGames.Plants
{
    ...
    {
        public ProceduralTreeData treeData;
        ...
        public static GameObject Create(GameObject _prefab, ProceduralTreeData _treeData, Vector3 _position, Transform _parent = null)
        {
            GameObject tree = Instantiate(_prefab, _position, Quaternion.identity, _parent);
            tree.name = _treeData.name;

            tree.GetComponent<ProceduralTree>().treeData = _treeData;
